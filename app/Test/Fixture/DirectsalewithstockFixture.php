<?php
/**
 * DirectsalewithstockFixture
 *
 */
class DirectsalewithstockFixture extends CakeTestFixture {
 ...
 * @var string
 */
	public $table = 'directsalewithstock';
 ...
 */
	public $fields = array(
		...
		'indexes' => array(
			...
			'index_foreignkey_directsalewithstock_client_ref' => array('column' => 'client_ref_id', 'unique' => 0)
		),
